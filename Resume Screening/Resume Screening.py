...
num = int(input("How many resumes do you wish to shortlist?  "))
path2 = input("Input path of your project folder: ")
path = path2 + r"\Resumes"
...
def start():
  ...
  e = time.time()
  print(e - s, "sec\n")
  top_docs = get_top_docs(num) #get top documents based on similarity
...
if __name__ == '__main__':
 ...
 # bg_image = ImageTk.PhotoImage(img2)       
  ...
  canv.create_image(0, 0,  anchor='nw') #image=bg_image,
